    ...
    <div className="space-y-6">
      <Form {...form}>
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                ...
                <FormItem className="flex flex-col">
                  ...
                  <FormControl>
                    <InputMask
                      ...
                      required
                      disabled={isPending}
                      className="pl-3 bg-input-color py-2 rounded-md text-black"
                    />
                  </FormControl>
                  <FormMessage />
                </FormItem>
          ...
          <Button
            type="submit"
            className="w-full bg-realce text-black font-bold hover:bg-realce/50 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
            disabled={isPending}
          >
            {isPending && (
              <svg
